    ...
    return (
      ...
      <div className="mt-0 transition-all duration-200 ease-soft-in-out">
        <section className="absolute w-full h-full">
          <div className="absolute top-0 w-full h-full bg-gray-900 relative flex items-start pt-12 pb-56 m-4 overflow-hidden bg-center bg-cover min-h-50-screen rounded-xl" style={{backgroundImage: 'url("../soft-ui-dashboard-tailwind/assets/img/curved-images/curved14.jpg")'}}>
          ...
          <div className="container relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
