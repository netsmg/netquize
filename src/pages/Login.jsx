    ...
    return (
      ...
      <div className="mt-0 transition-all duration-200 ease-soft-in-out">
        <section className="absolute w-full h-full">
          <div className="absolute top-0 w-full h-full bg-gray-900 relative flex items-start pt-12 pb-56 m-4 overflow-hidden bg-center bg-cover min-h-50-screen rounded-xl" style={{backgroundImage: 'url("assets/Logo-ce358f5d.svg")'}}>
